...
window.APP_DATA = {
  ...
  "items": [
    ...
    {
      "id": "item_1779174139303",
      "title": "班級布告欄(聯絡簿)",
      "category": "班級經營",
      "description": "一款專為班級經營、社團管理與教育現場打造的輕量化數位看板應用程式。本系統採用前瞻性的 Local-First（本機端優先）架構，具備以下核心優勢：\n完全地端運行，保障隱私：系統為單一 HTML 檔案，無需架設伺服器、無需連上網際網路即可運行。所有公告資料均加密儲存於您設備的瀏覽器資料庫（IndexedDB）中，徹底杜絕學生個資或班級內部資訊外洩的風險。\n跨平台與響應式設計 (RWD)：完美支援桌上型電腦、平板電腦（iPad/Android Tablet）與智慧型手機。介面將根據設備螢幕尺寸自動最佳化，提供流暢的觸控與閱讀體驗。\n為家長通訊群組最佳化：內建「沉浸式展示模式」，可一鍵隱藏日曆並放大字體，極度適合直接截圖並轉發至班級 LINE 群組，確保家長在手機上也能清晰閱讀。\n",
    ...
    {
      "id": "item_1780556585440",
      "title": "NotebookLM 簡報風格實驗室",
      "category": "其他",
      "description": "解決 NotebookLM 生成投影片過於陽春或隨機的痛點，為使用者打造專屬的提示詞管理工具。核心特色如下：\n1. 13 種高質感內建風格：涵蓋數位普普、現代雜誌、3D 數位城市等 10 種熱門風格，以及「高階顧問風」、「2.5D 立體風」與「軟體服務風」3 種進階專業風格。\n2. 四段式 YAML 標準結構：將風格指令重構為「簡報基本資訊、視覺佈局約束、文案規則、推進邏輯」4 階段控制規格，讓 AI 穩定產出具備強烈美學或商務質感的簡報。\n3. 專屬提示詞收集管理盒：提供一款年輕、清爽亮色系設計的單頁應用程式（SPA），能一鍵注入主題變數並生成提示詞。提供系統維護模式，支援新增、編輯與匯出 `notebooklm_style.js` 檔案，方便分享同步。",
      "link": "notebooklm_style.html",
      "icon": "Sliders",
      "color": "purple",
      "grade": "其他"
    },
    ...
    {
      "id": "item_1788760322746",
      "title": "食登數據轉檔與智慧分析檢核系統",
      "category": "校務",
      "description": "為解決現行學校營養午餐管理與「校園食材登錄平台」申報實務，第一線行政人員與營養師面臨的問題，包括：原始配膳試算表（如單餐日記、出貨單等）格式極易因學期、合約商或系統更新而產生結構性偏移；大量繁瑣的申報欄位（如西元日期標準化、加工品智慧判定、溯源履歷等）耗費大量人工進行二次校對與補登等問題。",
      "link": "food_login2.html",
      "icon": "Logs",
      "color": "sky",
      "grade": "校務"
    }
